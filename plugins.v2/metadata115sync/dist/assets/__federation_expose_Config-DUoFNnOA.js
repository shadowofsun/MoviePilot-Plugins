...
return (_ctx, _cache) => {
  ...
  return (_openBlock(), _createElementBlock("div", _hoisted_1, [
    _createVNode(_component_VToolbar, {
      ...
      default: _withCtx(() => [
        _cache[7] || (_cache[7] = _createElementVNode("div", { class: "text-h6 ms-3" }, "元数据115同步配置", -1)),
            ...
            _createVNode(_component_VCardText, null, {
              default: _withCtx(() => [
                    ...
                    _createVNode(_component_VCol, {
                      ...
                      default: _withCtx(() => [
                        _createVNode(_component_VTextField, {
                          ...
                          "onUpdate:modelValue": _cache[2] || (_cache[2] = $event => ((localConfig.value.cron) = $event)),
                    ...
                    _createVNode(_component_VCol, {
                      ...
                      default: _withCtx(() => [
                        _createVNode(_component_VTextField, {
                          ...
                          "onUpdate:modelValue": _cache[3] || (_cache[3] = $event => ((localConfig.value.interval) = $event)),
                ...
                _createVNode(_component_VSwitch, {
                  ...
                  "onUpdate:modelValue": _cache[4] || (_cache[4] = $event => ((localConfig.value.onlyonce) = $event)),
                  label: "保存后立即运行一次",
                  color: "primary"
                }, null, 8, ["modelValue"]),
                _createVNode(_component_VSwitch, {
                  modelValue: localConfig.value.notify,
                  "onUpdate:modelValue": _cache[5] || (_cache[5] = $event => ((localConfig.value.notify) = $event)),
                  label: "同步完成后发送通知",
                  color: "primary"
                }, null, 8, ["modelValue"]),
                _createVNode(_component_VTextField, {
                  modelValue: localConfig.value.upload_delay,
                  "onUpdate:modelValue": _cache[6] || (_cache[6] = $event => ((localConfig.value.upload_delay) = $event)),
                  modelModifiers: { number: true },
                  label: "上传间隔（秒）",
                  type: "number",
                  min: "0",
        ...
        _createVNode(_component_VCard, null, {
          default: _withCtx(() => [
            _createVNode(_component_VCardTitle, { class: "d-flex align-center" }, {
              default: _withCtx(() => [
                _cache[11] || (_cache[11] = _createTextVNode(" 目录映射 ", -1)),
                _createVNode(_component_VSpacer),
                _createVNode(_component_VBtn, {
                  size: "small",
                  color: "primary",
